...
const TEMAS = {
    economia: {
        id: 'economia',
        gid: '1919087106', // TU NÚMERO REAL DE ECONOMÍA
    ...
    return (
        <div className="flex flex-col h-screen w-full bg-gray-100 font-sans overflow-hidden">
            ...
            <header className="bg-white px-4 py-2 shadow-sm z-50 flex justify-between items-center border-b shrink-0 h-14">
                ...
                {/* BOTÓN IDIOMA CORREGIDO: Muestra el idioma ACTUAL */}
                <button
            ...
            <div className="flex flex-1 overflow-hidden flex-row relative">
                ...
                {/* LÓGICA DE TAMAÑO: Si hay provincia seleccionada, ancho = 1/3 (33%). Si no, ancho = full. */}
                <div className={`
        ...
        `}>
                ...
                {/* Ocupa el espacio restante (flex-1) que es 2/3 cuando el mapa se achica */}
